// Script for the application of the MET XY shift correction, which reduces the phi modulation in the MET by shifting the origin of the coordinate in the transverse plane
// Code taken from Laurent Thomas here: https://lathomas.web.cern.ch/METStuff/XYCorrections/XYMETCorrection_withUL17andUL18andUL16.h
...
std::pair<double,double> METXYCorr_Met_MetPhi(std::string setname, std::string year_in, bool isMC, double uncormet, double uncormet_phi, int npv, bool isUL=true, bool ispuppi=false){
  // (TString) setname: name of dataset to process (<PD><Era>, e.g. SingleMuonDataB) or an arbitrary MC process name 
  // (TString) year_in: year ("16APV", "16", "17", or "18")
  
  std::string year;
  if (InString("16",year_in)) {
    if (InString("APV",year_in)) {
      year = "2016APV";
    }
    else {
      if (isUL) { 
  ...
  else if(isMC && year == "2016APV" && isUL) runera = yUL2016APVMC;
  else if(isMC && year == "2016nonAPV" && isUL) runera = yUL2016nonAPVMC;
  else if(isMC && year == "2017" && isUL) runera = yUL2017MC;
  else if(isMC && year == "2018" && isUL) runera = yUL2018MC;
  
  
  else if(!isMC && year == "2016" && InString("DataB",setname) && !isUL) runera = y2016B;
  else if(!isMC && year == "2016" && InString("DataC",setname) && !isUL) runera = y2016C;
  else if(!isMC && year == "2016" && InString("DataD",setname) && !isUL) runera = y2016D;
  else if(!isMC && year == "2016" && InString("DataE",setname) && !isUL) runera = y2016E;
  else if(!isMC && year == "2016" && InString("DataF",setname) && !isUL) runera = y2016F;
  else if(!isMC && year == "2016" && InString("DataG",setname) && !isUL) runera = y2016G;
  else if(!isMC && year == "2016" && InString("DataH",setname) && !isUL) runera = y2016H;
  
  else if(!isMC && year == "2017" && InString("DataB",setname) && !isUL){ runera = y2017B; usemetv2 =true;}
  else if(!isMC && year == "2017" && InString("DataC",setname) && !isUL){ runera = y2017C; usemetv2 =true;}
  else if(!isMC && year == "2017" && InString("DataD",setname) && !isUL){ runera = y2017D; usemetv2 =true;}
  else if(!isMC && year == "2017" && InString("DataE",setname) && !isUL){ runera = y2017E; usemetv2 =true;}
  else if(!isMC && year == "2017" && InString("DataF",setname) && !isUL){ runera = y2017F; usemetv2 =true;}
  
  else if(!isMC && year == "2018" && InString("DataA",setname) && !isUL) runera = y2018A;
  else if(!isMC && year == "2018" && InString("DataB",setname) && !isUL) runera = y2018B;
  else if(!isMC && year == "2018" && InString("DataC",setname) && !isUL) runera = y2018C;
  else if(!isMC && year == "2018" && InString("DataD",setname) && !isUL) runera = y2018D;

  else if(!isMC && year == "2018" && InString("DataA",setname) && isUL) runera = yUL2018A;
  else if(!isMC && year == "2018" && InString("DataB",setname) && isUL) runera = yUL2018B;
  else if(!isMC && year == "2018" && InString("DataC",setname) && isUL) runera = yUL2018C;
  else if(!isMC && year == "2018" && InString("DataD",setname) && isUL) runera = yUL2018D;

  else if(!isMC && year == "2017" && InString("DataB",setname) && isUL){ runera = yUL2017B; usemetv2 =false;}
  else if(!isMC && year == "2017" && InString("DataC",setname) && isUL){ runera = yUL2017C; usemetv2 =false;}
  else if(!isMC && year == "2017" && InString("DataD",setname) && isUL){ runera = yUL2017D; usemetv2 =false;}
  else if(!isMC && year == "2017" && InString("DataE",setname) && isUL){ runera = yUL2017E; usemetv2 =false;}
  else if(!isMC && year == "2017" && InString("DataF",setname) && isUL){ runera = yUL2017F; usemetv2 =false;}

  else if(!isMC && year == "2016APV" && InString("DataB",setname) && isUL) runera = yUL2016B;
  else if(!isMC && year == "2016APV" && InString("DataC",setname) && isUL) runera = yUL2016C;
  else if(!isMC && year == "2016APV" && InString("DataD",setname) && isUL) runera = yUL2016D;
  else if(!isMC && year == "2016APV" && InString("DataE",setname) && isUL) runera = yUL2016E;
  else if(!isMC && year == "2016APV" && InString("DataF",setname) && isUL) runera = yUL2016F;
  else if(!isMC && year == "2016nonAPV" && InString("DataF",setname) && isUL) runera = yUL2016Flate;
  else if(!isMC && year == "2016nonAPV" && InString("DataG",setname) && isUL) runera = yUL2016G;
  else if(!isMC && year == "2016nonAPV" && InString("DataH",setname) && isUL) runera = yUL2016H;


  else {
    //Couldn't find data/MC era => no correction applied
    std::cout << "Couldn't find data/MC era => no MET XY-shift correction applied";
  ...
  if(!usemetv2){//Current recommendation for 2016 and 2018
    ...
    if(runera==yUL2016nonAPVMC) METxcorr = -(-0.153497*npv +-0.231751);
    if(runera==yUL2016nonAPVMC) METycorr = -(0.00731978*npv +0.243323);
    if(runera==yUL2016APVMC) METxcorr = -(-0.188743*npv +0.136539);
    if(runera==yUL2016APVMC) METycorr = -(0.0127927*npv +0.117747);
    ...
    if(runera==yUL2016nonAPVMC) METxcorr = -(-0.0058341*npv +-0.395049);
    if(runera==yUL2016nonAPVMC) METycorr = -(0.00971595*npv +-0.101288);
    if(runera==yUL2016APVMC) METxcorr = -(-0.0060447*npv +-0.4183);
    if(runera==yUL2016APVMC) METycorr = -(0.008331*npv +-0.0990046);
