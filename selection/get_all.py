...
def organize_bkg_hists(backgrounds):
    ...
    for setname in backgrounds:
        ...
        for region in ['pass_SR','fail_SR','pass_ttCR','fail_ttCR']:
            systs = {
                '16APV' : ['L1PreFiringWeight_up','L1PreFiringWeight_down','Pileup_up','Pileup_down','JES_up','JES_down','JMS_up','JMS_down','JER_up','JER_down','JMR_up','JMR_down'],
                '16' : ['L1PreFiringWeight_up','L1PreFiringWeight_down','Pileup_up','Pileup_down','JES_up','JES_down','JMS_up','JMS_down','JER_up','JER_down','JMR_up','JMR_down'],
                '17' : ['L1PreFiringWeight_up','L1PreFiringWeight_down','Pileup_up','Pileup_down','JES_up','JES_down','JMS_up','JMS_down','JER_up','JER_down','JMR_up','JMR_down'],
                '18' : ['Pileup_up','Pileup_down','JES_up','JES_down','JMS_up','JMS_down','JER_up','JER_down','JMR_up','JMR_down']
            }
...
if __name__ == '__main__':
    ...
    #MakeRun2()
    #combine_ttbar()
    #organize_bkg_hists(['XHY-2000-1000','ttbar','WWto1L1Nu2Q','WZto1L1Nu2Q'])
    organize_bkg_hists(['XHY-1000-500'])
