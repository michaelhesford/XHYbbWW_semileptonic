...
echo python JetToLep_selection.py $*
python JetToLep_selection.py $*

xrdcp -f *.root root://cmseos.fnal.gov//store/user/mhesford/XHYbbWW_semileptonic/plots/JetToLep/
