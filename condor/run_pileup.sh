...
echo python XHYbbWW_pileup.py $*
python XHYbbWW_pileup.py $*

xrdcp -f XHYbbWW_pileup_*.root root://cmseos.fnal.gov//store/user/mhesford/XHYbbWW_semileptonic/pileup/
~                                                                                                    
