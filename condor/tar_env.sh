...
cd $CMSSW_BASE/../
tar --exclude-caches-all --exclude-vcs --exclude-caches-all --exclude-vcs -cvzf XHYbbWW_semileptonic.tgz CMSSW_11_1_4 --exclude=tmp --exclude=".scram" --exclude=".SCRAM" --exclude=CMSSW_11_1_4/src/timber-env --exclude=CMSSW_11_1_4/src/semileptonic/*.root --exclude=CMSSW_11_1_4/src/semileptonic/logs --exclude=CMSSW_11_1_4/src/TIMBER/docs --exclude=CMSSW_11_1_4/src/semileptonic/plots
